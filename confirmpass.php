...
if(isset($_POST['btn_submit'])) {
     if($newpassword == $confirmpassword){
        $sql = "UPDATE patient set password='".$newpassword."' WHERE patientid = '".$_GET['patientid']."'";
        ...
        <div class="popup__background"></div>
            ...
            <p>
            <?php echo "<script>setTimeout(\"location.href = 'login_patient.php';\",1500);</script>"; ?>
            </p>
        </div>
        </div>
        <?php
        ...
        <div class="popup__content">
            ...
            <p>
            <a href="confirmpass.php?patientid=<?php echo $_GET['patientid'] ?>"><button class="button button--error" data-for="js_error-popup">Close</button></a>
            </p>
        </div>
        </div>
