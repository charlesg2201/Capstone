...
{
    $sql = "SELECT * FROM patient WHERE security_question='".$security_question."' AND security_answer='".$security_answer."'";
    ...
    {       
        ?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          <div class="popup__background"></div>
            ...
            <p>
             <?php echo "<script>setTimeout(\"location.href = 'confirmpass.php?patientid=".$_SESSION["id"]."';\",1500);</script>"; ?>
            </p>
          </div>
        </div>
     <?php
     ...
     <div class="popup popup--icon -error js_error-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>
          <a href="resetpass.php?patientid=<?php echo $_GET['patientid'] ?>"><button class="button button--error" data-for="js_error-popup">Close</button></a>
        </p>
      </div>
    </div>
