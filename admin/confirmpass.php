...
if(isset($_POST['btn_submit'])) {
     if($newpassword == $confirmpassword){
        $sql = "UPDATE tbl_admin_user set password='".$newpassword."' WHERE userid = '".$_GET['userid']."'";
        ...
        <div class="popup__content">
            ...
            <p>
            <a href="confirmpass.php?userid=<?php echo $_GET['userid'] ?>"><button class="button button--error" data-for="js_error-popup">Close</button></a>
            </p>
        </div>
        </div>
