...
if (isset($_GET['editid'])) {
    ...
    $selectQuery = "SELECT questions, question_type, choices FROM tbl_health WHERE question_id = $editId";
...
if (isset($_POST['btn_submit'])) {
    ...
    if (isset($_GET['editid'])) {
        $sql = "UPDATE tbl_health SET questions='$questions', question_type='$question_type', choices='$choices' WHERE question_id='$editId'";
...
<?php
        ...
        $sql = "INSERT INTO tbl_health (questions, question_type, choices) VALUES (?, ?, ?)";
