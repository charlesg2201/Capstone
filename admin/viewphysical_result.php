    ...
    <div class="pcoded-content">
        <div class="pcoded-inner-content">
            <div class="main-body">
                <div class="page-body">
                    <div class="card">
                    <div class="box-header" style="background-color: #0a4b78; text-align: center; font-family: 'Calibri', sans-serif;"><h4 style="color: #ffffff;">Physical Assessment Results</h4></div>
