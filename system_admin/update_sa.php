...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['editid'])) {
        $sql = "UPDATE tbl_admin SET firstname='$fname', middlename='$middlename', lname='$lname', dob='$dob', contact='$contact', gender='$gender', employee_number='$employee_number', addr='$addr' WHERE id='$_GET[editid]'";
...
<?php
            ...
            $sql = "INSERT INTO `tbl_admin` (`firstname`, `middlename`, `lname`, `dob`, `contact`, `username`, `password`, `gender`, `employee_number`, `addr`, `date`) VALUES ('$fname', '$middlename', '$lname', '$dob', '$contact', '$username', '$password',  '$gender', '$employee_number', '$addr', '$date')";
            if ($qsql = mysqli_query($conn, $sql)) {
?>
                <div class="popup popup--icon -success js_success-popup popup--visible">
                    <div class="popup__background"></div>
