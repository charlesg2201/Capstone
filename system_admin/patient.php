...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE patient SET fname='$_POST[fname]',lname='$_POST[lname]',guardian_name='$_POST[guardian_name]',admissiondate='$_POST[admissiondate]',admissiontime='$_POST[admissiontime]',address='$_POST[address]',contact='$_POST[contact]',studentid='$_POST[studentid]',reasons='$_POST[select2]',gender='$_POST[gender]',dob='$_POST[dateofbirth]' WHERE patientid='$_GET[editid]'";
...
<?php
    ...
    else
    {
        ...
        $sql ="INSERT INTO patient(fname,lname,guardian_name,admissiondate,admissiontime,address,contact,studentid,password,reasons,gender,dob,status) values('$_POST[fname]',$_POST[lname]',$_POST[guardian_name]','$_POST[admissiondate]','$_POST[admissiontime]','$_POST[address]','$_POST[contact]','$_POST[studentid]','$pass','$_POST[select2]','$_POST[gender]','$_POST[dateofbirth]','Active')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
...
<li class="breadcrumb-item"><a href="patient.php">Patient</a>
</li>
</ul>
</div>
</div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" type="text" name="studentid" id="studentid"
                        value="<?php if(isset($_GET['editid'])) { echo $rsedit['studentid']; } ?>" />
            <span class="messages"></span>
        </div>
