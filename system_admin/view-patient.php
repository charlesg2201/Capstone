                    ...
                    <?php
                      ...
                      while($rs = mysqli_fetch_array($qsql))
                      {
                        echo "<tr>
                          ...
                          <strong>Student ID :</strong> $rs[studentid] <br> 
                          <strong>Reasons</strong>: $rs[reasons]<br>
                          <strong>Gender</strong>: &nbsp;$rs[gender]<br>
                          <strong>DOB</strong>: &nbsp$rs[dob]</td>
                          <td>
                          <strong>Date</strong>: &nbsp;$rs[admissiondate]<br>
                          <strong>Time</strong>: &nbsp;$rs[admissiontime]</td>
                          <td>$rs[address]<br></td>
                          <td><strong>Guardian Name</strong>: &nbsp;$rs[guardian_name]<br>
